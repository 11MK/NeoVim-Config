...
_G.packer_plugins = {
  ...
  ["copilot.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/max/.local/share/nvim/site/pack/packer/opt/copilot.lua",
    url = "https://github.com/zbirenbaum/copilot.lua"
  },
  ["everforest-nvim"] = {
    config = { "\27LJ\2\n8\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\15everforest\frequire\0" },
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/everforest-nvim",
    url = "https://github.com/neanias/everforest-nvim"
  },
  ["flash.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/flash.nvim",
  ...
  ["heirline.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/heirline.nvim",
  ...
  ["one-small-step-for-vimkind"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/one-small-step-for-vimkind",
  ...
  ["onenord.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/onenord.nvim",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
    url = "https://github.com/simrat39/rust-tools.nvim"
  },
  ["telescope-dap.nvim"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/telescope-dap.nvim",
  ...
  ["todo-comments.nvim"] = {
    ...
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/todo-comments.nvim",
  ...
  ["vim-illuminate"] = {
    loaded = true,
    path = "/home/max/.local/share/nvim/site/pack/packer/start/vim-illuminate",
